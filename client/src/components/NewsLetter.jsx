			...
			<div className="container mx-auto p-7 sm:p-10 md:p-12 xl:p-14 md:rounded-lg flex flex-col lg:flex-row items-center justify-between gap-5 xl:gap-20 bg-slate-800 text-white w-full md:max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
				...
				<div className="w-full relative">
					<input
						...
						id="email"
						required
						className="dark:text-white py-4 sm:py-5 text-sm sm:text-base px-5 sm:px-7 rounded-full text-black pr-16 sm:pr-36 w-full"
					/>
					<button
						type="submit"
						className="rounded-full bg-slate-800 hover:bg-slate-700 hover:text-white sm:px-6 px-3 py-3 dark:text-white flex items-center gap-1 absolute top-1/2 -translate-y-1/2 right-1 sm:right-2"
					>
